...
class RsudDahaHusadaKetersediaanKamarPage extends StatefulWidget {
  ...
  @override
  State<RsudDahaHusadaKetersediaanKamarPage> createState() => _RsudDahaHusadaKetersediaanKamarPageState();
}
...
class _RsudDahaHusadaKetersediaanKamarPageState extends State<RsudDahaHusadaKetersediaanKamarPage> {
  ...
  Widget _buildRoomCard(KamarRawatDaha kamar) {
    Color badgeColor;
    Color badgeBg;
    Color statusColor;
    Color statusBg;
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => RsudDahaHusadaDetailKamarPage(kamar: kamar),
          ),
        );
      },
      child: Container(
...
class RsudDahaHusadaDetailKamarPage extends StatelessWidget {
  final KamarRawatDaha kamar;

  const RsudDahaHusadaDetailKamarPage({
    super.key,
    required this.kamar,
  });
